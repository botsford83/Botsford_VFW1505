...
//@interface Botsford_Bryan_project1Object : NSObject
//@end

@interface Botsford_Bryan_project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Botsford_Bryan_project1Object class]])
		{
			for (NSString *key in [[(Botsford_Bryan_project1Object*)o modules] allKeys])
			{
