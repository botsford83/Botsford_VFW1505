...
/**
 Base class for all Botsford_Bryan_project1 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Botsford_Bryan_project1 view hierarchy (such as wrapped iOS UIViews) was touched.
