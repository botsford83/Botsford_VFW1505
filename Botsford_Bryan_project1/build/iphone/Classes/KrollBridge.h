...
@interface Botsford_Bryan_project1Object : KrollCoverageObject {
#else
@interface Botsford_Bryan_project1Object : KrollObject {
#endif
@private
...
extern NSString * Botsford_Bryan_project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Botsford_Bryan_project1Object *_botsford_bryan_project1;
    KrollObject* console;
	BOOL shutdown;
