...
// in simulator we redefine to format for Botsford_Bryan_project1 Developer console
...
{\
	NSString * exceptionName = [@"org.botsford_bryan_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.botsford_bryan_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBotsford_Bryan_project1NativeItemNone = -1, 
	UIBotsford_Bryan_project1NativeItemSpinner = -2,
	UIBotsford_Bryan_project1NativeItemProgressBar = -3,
	
	UIBotsford_Bryan_project1NativeItemSlider = -4,
	UIBotsford_Bryan_project1NativeItemSwitch = -5,
	UIBotsford_Bryan_project1NativeItemMultiButton = -6,
	UIBotsford_Bryan_project1NativeItemSegmented = -7,
	
	UIBotsford_Bryan_project1NativeItemTextView = -8,
	UIBotsford_Bryan_project1NativeItemTextField = -9,
	UIBotsford_Bryan_project1NativeItemSearchBar = -10,
	
	UIBotsford_Bryan_project1NativeItemPicker = -11,
	UIBotsford_Bryan_project1NativeItemDatePicker = -12,
	
	UIBotsford_Bryan_project1NativeItemInfoLight = -13,
	UIBotsford_Bryan_project1NativeItemInfoDark = -14,
	
	UIBotsford_Bryan_project1NativeItemDisclosure = -15,
	
	UIBotsford_Bryan_project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Botsford_Bryan_project1 instances of
