...
// in simulator we redefine to format for Botsford_Bryan_Project2 Developer console
...
{\
	NSString * exceptionName = [@"org.botsford_bryan_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.botsford_bryan_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBotsford_Bryan_Project2NativeItemNone = -1, 
	UIBotsford_Bryan_Project2NativeItemSpinner = -2,
	UIBotsford_Bryan_Project2NativeItemProgressBar = -3,
	
	UIBotsford_Bryan_Project2NativeItemSlider = -4,
	UIBotsford_Bryan_Project2NativeItemSwitch = -5,
	UIBotsford_Bryan_Project2NativeItemMultiButton = -6,
	UIBotsford_Bryan_Project2NativeItemSegmented = -7,
	
	UIBotsford_Bryan_Project2NativeItemTextView = -8,
	UIBotsford_Bryan_Project2NativeItemTextField = -9,
	UIBotsford_Bryan_Project2NativeItemSearchBar = -10,
	
	UIBotsford_Bryan_Project2NativeItemPicker = -11,
	UIBotsford_Bryan_Project2NativeItemDatePicker = -12,
	
	UIBotsford_Bryan_Project2NativeItemInfoLight = -13,
	UIBotsford_Bryan_Project2NativeItemInfoDark = -14,
	
	UIBotsford_Bryan_Project2NativeItemDisclosure = -15,
	
	UIBotsford_Bryan_Project2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Botsford_Bryan_Project2 instances of
