...
//Rare exceptions to indicate a bug in the _botsford_bryan_project2 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Botsford_Bryan_Project2 proxies.
 */
