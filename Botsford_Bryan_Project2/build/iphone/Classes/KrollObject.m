...
//@interface Botsford_Bryan_Project2Object : NSObject
//@end

@interface Botsford_Bryan_Project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Botsford_Bryan_Project2Object class]])
		{
			for (NSString *key in [[(Botsford_Bryan_Project2Object*)o modules] allKeys])
			{
