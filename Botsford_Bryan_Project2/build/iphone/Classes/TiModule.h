...
/**
 The base class for all Botsford_Bryan_Project2 modules
 */
...
/**
 Botsford_Bryan_Project2 Platform calls this method on startup.
 */
-(void)startup;

/**
 Botsford_Bryan_Project2 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Botsford_Bryan_Project2 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Botsford_Bryan_Project2 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Botsford_Bryan_Project2 Platform calls this method on resume.
 @param sender The sender of the event.
 */
