...
@interface Botsford_Bryan_Project2Object : KrollCoverageObject {
#else
@interface Botsford_Bryan_Project2Object : KrollObject {
#endif
@private
...
extern NSString * Botsford_Bryan_Project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Botsford_Bryan_Project2Object *_botsford_bryan_project2;
    KrollObject* console;
	BOOL shutdown;
