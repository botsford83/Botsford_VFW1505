...
/**
 Base class for all Botsford_Bryan_Project2 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Botsford_Bryan_Project2 view hierarchy (such as wrapped iOS UIViews) was touched.
